...
- Add support ticket assignment rules by category, city, seller cluster, and priority.
- Add escalation timers for overdue customer, seller, delivery, and refund tickets.
- Add canned reply templates in English/Hindi/local launch language.
- Add support call log, WhatsApp handoff, email fallback, and customer satisfaction rating.
- Add attachment upload for damaged/missing item evidence and seller document/label screenshots.
- Add supervisor dashboard for breached support SLA, repeat seller issues, and refund aging.
...
- Customer app can raise order-linked support tickets and view customer-visible replies.
- Seller app can raise order-linked Ops escalations for delivery, print, payout, catalogue, and document blockers.
- Ops/Admin web has a Support Desk with status, priority, SLA due time, internal notes, and customer/seller replies.
- Prepaid seller rejections automatically create refund-review support tickets for Ops follow-up.
